...
import { Radio, Button, Icon, Avatar } from 'antd';
...
class Poll extends Component {
    constructor(props){
        super(props)
        console.log("logging polls indise poll ",props)
    }
    ...
    render() {
        ...
        if(this.props.poll.selectedChoice || this.props.poll.expired){
            ...
            console.log("this is the winning choice ",winningChoice);
 
            this.props.poll.choices.forEach((choice, choiceIndex)=>{
                pollChoices.push(<CompletedOrVotedPollChoices
                    key={choice.id}
                    choice={choice.id}
        ...
        return (
            <div className="poll-content">
                ...
                <div className="poll-footer">
                    {
                        !(this.props.selectedChoice || this.props.poll.expired)?
...
function CompletedOrVotedPollChoices(props){
    return(
        <div className="cv-poll-choice">
            <span className="cv-poll-choice-details">
                ...
                {props.isSelected? (
                    <Icon className='selected-choice-icon'
                        type='check-circle-o'
                    />
                ):null}
            </span>
